...
export const privateBootstrapPluginPackage = (): PrivateBootstrapPluginPackage => {
	...
	const bootstrapEntry = "api/scripts/bootstrap.sandbox.ts";
	const operationEntry = "api/scripts/operation.sandbox.ts";
...
export const privateImportPluginPackage = (
	...
	const entry = "api/scripts/private-import.sandbox.ts";
...
export const privateIntegrationPluginPackage = (
	...
	const entry = "api/scripts/private-integration.sandbox.ts";
