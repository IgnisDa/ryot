...
export const personPropertiesSchema = z
	.object({
		...
		website: nullableStringSchema.describe(
			"Official website or online presence of this person",
		),
		...
		birthPlace: nullableStringSchema.describe(
			"City or country where this person was born",
		),
		description: nullableStringSchema.describe(
			"Biography or summary provided by the data provider",
		),
		alternateNames: stringArraySchema.describe(
