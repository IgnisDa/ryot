...
const workoutPropertiesSchema = z
	.object({
		startedAt: z.iso
			.datetime()
			.describe("Date and time this workout session began"),
		comment: z
			.string()
			.nullish()
			.describe("Optional notes or comments about this workout"),
		endedAt: z.iso
			.datetime()
			.nullish()
			.describe("Date and time this workout session ended"),
		caloriesBurnt: z
			.number()
			.int()
			.nullish()
...
const workoutSetPropertiesSchema = z
	.object({
		...
		weight: z
			.number()
			.nullish()
			.describe("Weight used in this set in the user's preferred unit"),
