...
driver("details", async function (context) {
	...
	const lifeSpan = artist?.["life-span"];
	const birthDate =
		lifeSpan && typeof lifeSpan === "object" ? getNullableString(lifeSpan.begin) : null;
	const deathDate =
		lifeSpan && typeof lifeSpan === "object" ? getNullableString(lifeSpan.end) : null;
