...
async function getCompleteSchema(trigger) {
	const schemasResult = await listEventSchemas(trigger.entitySchemaId);
...
function getInheritedCompletionProperties(event) {
	...
	const inheritedProperties =
		event?.inheritedProperties && typeof event.inheritedProperties === "object"
			? event.inheritedProperties
			: {};
	const consumedOn =
		typeof properties.consumedOn === "string"
