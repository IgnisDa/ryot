...
| User                    | `changeUserRelationships`, `createEvents`, `ensureUserEntities`, `executeQueryEngine`, `getEntitySchemas`, `getIntegration`, `getUserPreferences`, `listEventSchemas`, `listIntegrations` |
