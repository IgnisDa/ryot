...
- V1 `entity_translation` rows are renamed to `old_entity_translation` before Drizzle migrations and copied into V2 translation overlays after their referenced entities exist. Title, description, and image variants become the V2 `name` and translatable `properties`; show/podcast episode translations resolve to their exploded episode entities.
