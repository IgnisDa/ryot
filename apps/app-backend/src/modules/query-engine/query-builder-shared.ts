...
export const buildQueryFilterClause = (
	input: QueryExpressionInput & { predicate: QueryFilter | null | undefined },
) => {
...
export const buildQueryResolvedFields = (input: {
	alias: string;
	runtime: QueryRuntime;
	fields: ReadonlyArray<RuntimeField>;
	computedFields: ReadonlyArray<QueryComputedField> | undefined;
}) => {
...
export const buildSortDirection = (direction: SavedViewSort["direction"]): SqlExpression => {
