...
- `tests/src/fixtures/query-engine.ts` (legacy tests)
- `tests/src/test-support/query-engine-suite.ts` (legacy tests)
- `tests/src/tests/query-engine.test.ts` (legacy tests)
