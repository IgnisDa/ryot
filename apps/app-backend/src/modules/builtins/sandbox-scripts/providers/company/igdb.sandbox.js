...
driver("search", async function (context) {
	...
	const items = results
		.map((company) => {
			...
			const externalId = typeof company.id === "number" ? String(company.id) : null;
			if (!externalId) {
				return null;
			}
