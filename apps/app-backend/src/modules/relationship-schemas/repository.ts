...
export class RelationshipSchemasRepository extends Effect.Service<RelationshipSchemasRepository>()(
	...
	{
		sync: () => ({
			createRelationshipSchema: Effect.fn("RelationshipSchemasRepository.createRelationshipSchema")(
				function* (input: {
					slug: Slug;
					name: string;
					userId: UserId;
			...
			findBySlugForUser: Effect.fn("RelationshipSchemasRepository.findBySlugForUser")(
			...
			getEntitySchemaScopeById: Effect.fn("RelationshipSchemasRepository.getEntitySchemaScopeById")(
			...
			listByUser: Effect.fn("RelationshipSchemasRepository.listByUser")(function* (input: {
				userId: UserId;
