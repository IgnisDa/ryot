...
export class EntityImportService extends Effect.Service<EntityImportService>()(
	"EntityImportService",
	{
		effect: Effect.gen(function* () {
			...
			return {
				import: Effect.fn("EntityImportService.import")(function* (
					user: CurrentUserValue,
					payload: {
				...
				getImportResult: Effect.fn("EntityImportService.getImportResult")(function* (
					user: CurrentUserValue,
					jobId: string,
				) {
			...
			} satisfies EntityImportServiceShape;
		}),
	},
) {}
