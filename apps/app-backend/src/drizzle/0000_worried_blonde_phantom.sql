...
ALTER TABLE "entity" ADD CONSTRAINT "entity_provider_id_sandbox_provider_id_fk" FOREIGN KEY ("provider_id") REFERENCES "public"."sandbox_provider"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "entity_provider_id_idx" ON "entity" USING btree ("provider_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "entity_global_external_id_unique" ON "entity" USING btree ("external_id","entity_schema_slug","provider_id") WHERE "entity"."user_id" is null;--> statement-breakpoint
CREATE UNIQUE INDEX "entity_global_no_provider_external_id_unique" ON "entity" USING btree ("external_id","entity_schema_slug") WHERE "entity"."user_id" IS NULL AND "entity"."provider_id" IS NULL;--> statement-breakpoint
