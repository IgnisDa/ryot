...
import {
	...
	type RateItem,
	type UpNextItem,
} from "./overview-sections_example";
...
export function MediaTrackerOverview() {
	...
	const heroItem = FAKE_CONTINUE[0];
	const stripItems = FAKE_CONTINUE.slice(1);
	...
	return (
		<Box className="flex-1 bg-background">
			...
			>
				...
				{/* Hero card — full bleed, breaks out of px-[28] */}
				<Box className="mt-5 px-[28]">
					<HeroCard item={heroItem} />
					<InProgressStrip items={stripItems} />
				</Box>
