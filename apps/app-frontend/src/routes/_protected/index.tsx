import { Box, Button, Container, Flex, Loader, Paper, Text, Title } from "@mantine/core";
		...
		<Container size="lg" px="md" pb={32} pt={56}>
			...
			>
				...
				<Text c="dimmed" size="lg" maw={672} mb={32}>
					A tropical, breathable app starter with full-document SSR, server functions, streaming,
					and type-safe routing. Calm on the eyes. Fast in production.
				</Text>
				...
				{!trackersQuery.isLoading && trackersQuery.isError && (
					<Flex align="center" direction="column" gap="xs">
						...
						<Button size="xs" variant="light" onClick={() => trackersQuery.refetch()}>
							Retry
						</Button>
					</Flex>
				)}

				{!trackersQuery.isLoading && !trackersQuery.isError && !hasEnabledTrackers && (
					<Text c="dimmed" size="sm">
						No enabled trackers yet. Hover the Tracking header in the sidebar and click + to create
						one.
					</Text>
				)}
