...
export function TrackerOverview(props: TrackerOverviewProps) {
	...
	const accentColor =
		props.facet.accentColor || props.entitySchemas[0]?.accentColor || "#D4A574";
	...
	if (overview.isError)
		return (
			<Stack gap="md">
				<TrackerOverviewHeader facet={props.facet} accentColor={accentColor} />
				<TrackerOverviewEmptyPanel
					isDark={isDark}
							...
							<Stack gap="md">
								...
								{overview.recentActivities.length === 0 ? (
									<Text c="dimmed" size="sm">
										This facet has no activity yet. Add your first entity or log
										the first event to bring it to life.
									</Text>
								) : (
									<Stack gap="sm">
						...
						<Stack gap="sm">
							...
							{overview.recentEntities.length === 0 ? (
								<TrackerOverviewEmptyPanel
									...
									description="Create the first entity in this facet to start building your overview."
								/>
							) : (
