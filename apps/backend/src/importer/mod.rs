...
impl ImportInput for DeployMediaTrackerImportInput {}
...
impl ImportInput for DeployGoodreadsImportInput {}
...
impl ImporterMutation {
    ...
    /// Add job to import data from MediaTracker.
    async fn deploy_goodreads_import(
        &self,
        gql_ctx: &Context<'_>,
        ...
        gql_ctx
            .data_unchecked::<ImporterService>()
            .deploy_goodreads_import(user_id, input)
            .await
    }
}
...
impl ImporterService {
    ...
    pub async fn deploy_goodreads_import(
        &self,
        user_id: i32,
        input: DeployGoodreadsImportInput,
    ) -> Result<String> {
