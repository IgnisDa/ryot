...
#[derive(Debug, InputObject, Serialize, Deserialize, Clone)]
pub struct GoodreadsImportInput {
...
impl ImporterMutation {
    ...
    async fn deploy_import(&self, gql_ctx: &Context<'_>, input: ImportInput) -> Result<String> {
        let user_id = user_id_from_ctx(gql_ctx).await?;
        gql_ctx
            .data_unchecked::<ImporterService>()
...
impl ImporterService {
    ...
    pub async fn deploy_import(&self, user_id: i32, mut input: ImportInput) -> Result<String> {
