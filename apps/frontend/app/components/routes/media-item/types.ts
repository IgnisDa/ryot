...
export type Season = NonNullable<MetadataDetails["showSpecifics"]>["seasons"][number];
export type SeasonProgress = NonNullable<UserMetadataDetails["showProgress"]>[number];
