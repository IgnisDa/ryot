...
| `file_storage.aws_access_key_id`      | The AWS access key ID for the file storage.                                                                                                                                   |
| `file_storage.aws_bucket_name`        | The name of the AWS bucket.                                                                                                                                                   |
| `file_storage.aws_secret_access_key`  | The AWS secret access key for the file storage.                                                                                                                               |
| `file_storage.aws_region`             | The AWS region for the file storage.                                                                                                                                          |
| `file_storage.aws_url`                | The AWS URL for the file storage.                                                                                                                                             |
