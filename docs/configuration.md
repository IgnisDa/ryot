...
!!! note
    ...
    You can see all possible configuration parameters in the [generated
    schema]({{ extra.file_path }}/libs/generated/src/config/backend/schema.ts).
    The defaults can be inspected in the [config](/apps/backend/src/config.rs) builder.
