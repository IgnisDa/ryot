...
All shows can be imported from [TvTime](https://tvtime.com/) at the moment, with
a external tool.

You can find all the necessary steps [here](https://github.com/SirMartin/TvTimeToRyot).
