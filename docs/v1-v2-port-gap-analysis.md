...
| Media & collection recommendations (`user_metadata_recommendations`, `collection_recommendations`)                                                                | `media-suggestion` relationship schema (`plugins/media/schemas/relationship-schemas.ts`) populated by `modules/entity-import/population.ts`'s `syncEntitySuggestions()`, triggered from `modules/entity-import/entity-import-workflow.ts`; consumed via ad hoc `modules/ryotql` documents                                                                                     | **Partial** — see [Recommendations — known gaps](#recommendations--known-gaps)                                                                                              |
