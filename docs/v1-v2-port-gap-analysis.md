...
The `media-suggestion` relationship graph is populated and both media and collection recommendations can be computed from it (verified in `tests/src/tests/plugins/media/query-engine/media-suggestions.test.ts`), but two things still separate this from V1:
