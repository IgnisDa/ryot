...
- [ ] Theme synchronization reuses the exact shared `PluginOperationError` contract and adds no theme-specific error union; unavailable or undeclared capabilities use `unsupported-capability` where applicable.
