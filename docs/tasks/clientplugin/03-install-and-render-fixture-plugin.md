...
- [x] The kernel transfers a `MessagePort` to the intended top-level plugin document, validates exact markers including bridge protocol V3, and receives a ready signal before presenting the plugin as loaded.
