...
- [x] The kernel transfers a `MessagePort` to the intended top-level plugin document, validates exact V1 markers, and receives a ready signal before presenting the plugin as loaded.
