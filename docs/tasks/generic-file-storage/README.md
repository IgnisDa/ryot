...
| 08  | [Codebase Cleanup](./08-codebase-cleanup.md)                                                                 | done   |

Task 07 remains partial because the legacy backup client is excluded through scoped
verification commands rather than persistent workspace-script filters.
