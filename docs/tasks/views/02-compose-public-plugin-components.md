...
- Reachability controls semantic checks, aggregate authored-source limits, stylesheet scanning, and emitted assets. Stylesheet scanning covers reachable contributor client sources, the UI SDK, and the client SDK.
