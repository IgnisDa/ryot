...
- **Pattern discovery**: Before writing new code, launch an `explore` subagent to find existing patterns and replicate them. Ask them not to create any files unless extremely necessary.
