...
pub async fn user_metadata_list(
    ...
    let (cache_id, response) = ss
        .cache_service
        .get_or_set_with_callback(key, ApplicationCacheValue::UserMetadataList, || async {
...
pub async fn user_people_list(
    ...
    let (cache_id, response) = ss
        .cache_service
        .get_or_set_with_callback(key, ApplicationCacheValue::UserPeopleList, || async {
            let preferences = user_by_id(user_id, ss).await?.preferences;
            let page: u64 = input
                .search
                .clone()
...
pub async fn user_workouts_list(
    ...
    let (cache_id, response) = ss
        .cache_service
        .get_or_set_with_callback(key, ApplicationCacheValue::UserWorkoutsList, || async {
            let preferences = user_by_id(user_id, ss).await?.preferences;
...
pub async fn user_exercises_list(
    ...
    let (cache_id, response) = ss
        .cache_service
        .get_or_set_with_callback(key, ApplicationCacheValue::UserExercisesList, || async {
            let preferences = user_by_id(user_id, ss).await?.preferences;
...
pub async fn user_measurements_list(
    ...
    let (cache_id, response) = ss
        .cache_service
        .get_or_set_with_callback(key, ApplicationCacheValue::UserMeasurementsList, || async {
