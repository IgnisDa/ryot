...
export const withoutMemberContext = <A, E, R>(state: {
	...
	SandboxEffect.mapInputContext(
		state.effect,
		// Preserve callback comments and its typed parameter.
		(context: Context.Context<R>) => omitWorkflowParent(context),
	);
