import{_ as i,c as a,o as n,ah as l}from"./chunks/framework.BwTf_eGd.js";const o=JSON.parse('{"title":"Configuration","description":"","frontmatter":{},"headers":[],"relativePath":"configuration.md","filePath":"configuration.md","lastUpdated":1751134505000}'),e={name:"configuration.md"};function t(p,s,h,k,r,E){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="configuration" tabindex="-1">Configuration <a class="header-anchor" href="#configuration" aria-label="Permalink to “Configuration”">​</a></h1><p>You can specify configuration options via environment variables. Each option is documented <a href="#all-parameters">below</a> with what it does and a default (if any).</p><p>Ryot serves the final configuration loaded at the <code>/backend/config</code> endpoint as JSON (<a href="https://demo.ryot.io/backend/config" target="_blank" rel="noreferrer">example</a>). Sensitive variables are redacted.</p><h2 id="important-parameters" tabindex="-1">Important parameters <a class="header-anchor" href="#important-parameters" aria-label="Permalink to “Important parameters”">​</a></h2><table tabindex="0"><thead><tr><th>Environment variable</th><th>Description</th></tr></thead><tbody><tr><td><code>TZ</code></td><td>Timezone to be used for cron jobs. Accepts values according to the IANA database. Defaults to <code>GMT</code>.</td></tr><tr><td><code>DISABLE_TELEMETRY</code></td><td>Disables telemetry collection using <a href="https://umami.is" target="_blank" rel="noreferrer">Umami</a>. Defaults to <code>false</code>.</td></tr><tr><td><code>DATABASE_URL</code></td><td>The Postgres database connection string.</td></tr><tr><td><code>MOVIES_AND_SHOWS_TMDB_ACCESS_TOKEN</code></td><td>The access token issued by TMDB. <strong>Required</strong> to enable movies and shows tracking. <a href="./guides/movies-and-shows.html">More information</a></td></tr><tr><td><code>VIDEO_GAMES_TWITCH_CLIENT_ID</code></td><td>The client ID issued by Twitch. <strong>Required</strong> to enable video games tracking. <a href="./guides/video-games.html">More information</a></td></tr><tr><td><code>VIDEO_GAMES_TWITCH_CLIENT_SECRET</code></td><td>The client secret issued by Twitch. <strong>Required</strong> to enable video games tracking.</td></tr><tr><td><code>SERVER_IMPORTER_TRAKT_CLIENT_ID</code></td><td>The client ID issued by Trakt. <strong>Required</strong> to enable Trakt import. <a href="./guides/trakt.html">More information</a></td></tr><tr><td><code>ANIME_AND_MANGA_MAL_CLIENT_ID</code></td><td>The client ID issued by MyAnimeList. <strong>Required</strong> to enable MyAnimeList import. <a href="./guides/myanimelist.html">More information</a></td></tr></tbody></table><h2 id="health-endpoint" tabindex="-1">Health endpoint <a class="header-anchor" href="#health-endpoint" aria-label="Permalink to “Health endpoint”">​</a></h2><p>The <code>/health</code> endpoint can be used for checking service healthiness. More information <a href="https://learn.microsoft.com/en-us/azure/architecture/patterns/health-endpoint-monitoring" target="_blank" rel="noreferrer">here</a>.</p><h2 id="all-parameters" tabindex="-1">All parameters <a class="header-anchor" href="#all-parameters" aria-label="Permalink to “All parameters”">​</a></h2><p>Please refer to the <code>@envvar</code> annotations to know which environment variable to use for a given parameter.</p><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Settings related to anime and manga.</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # The preferred language for media from this source.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar ANIME_AND_MANGA_ANILIST_PREFERRED_LANGUAGE</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    preferred_language</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;native&quot;</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar ANIME_AND_MANGA_MAL_CLIENT_ID</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # Settings related to locale for making requests Audible.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar AUDIO_BOOKS_AUDIBLE_LOCALE</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    locale</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;us&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar BOOKS_GOOGLE_BOOKS_API_KEY</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # Whether to pass the raw query string to the search API.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar BOOKS_GOOGLE_BOOKS_PASS_RAW_QUERY</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    pass_raw_query</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar BOOKS_HARDCOVER_API_KEY</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    api_key</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar BOOKS_OPENLIBRARY_COVER_IMAGE_SIZE</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar DATABASE_URL</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># @envvar DISABLE_TELEMETRY</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FILE_STORAGE_S3_ACCESS_KEY_ID</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FILE_STORAGE_S3_BUCKET_NAME</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FILE_STORAGE_S3_REGION</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FILE_STORAGE_S3_SECRET_ACCESS_KEY</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FILE_STORAGE_S3_URL</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FRONTEND_DASHBOARD_MESSAGE</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FRONTEND_OIDC_BUTTON_LABEL</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar FRONTEND_UMAMI_DOMAINS</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    domains</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # For example: https://umami.is/script.js.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar FRONTEND_UMAMI_SCRIPT_URL</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar FRONTEND_UMAMI_WEBSITE_ID</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar FRONTEND_URL</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Settings related to media.</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # Number of days after which a media should be removed from the Monitoring collection.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar MEDIA_MONITORING_REMOVE_AFTER_DAYS</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  monitoring_remove_after_days</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">30</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar MOVIES_AND_SHOWS_TMDB_ACCESS_TOKEN</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # The locale to use for making requests to TMDB API.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar MOVIES_AND_SHOWS_TMDB_LOCALE</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    locale</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;en&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # The locale to use for making requests to iTunes API.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar PODCASTS_ITUNES_LOCALE</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    locale</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;en_us&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar PODCASTS_LISTENNOTES_API_TOKEN</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # Run frequent cron tasks (syncing integrations, workout revisions) every \`n\` minutes.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SCHEDULER_FREQUENT_CRON_JOBS_EVERY_MINUTES</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  frequent_cron_jobs_every_minutes</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">5</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # Hours cron component for infrequent cron jobs (cleaning up data, refreshing calendar).</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SCHEDULER_INFREQUENT_CRON_JOBS_HOURS_FORMAT</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  infrequent_cron_jobs_hours_format</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;0&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_ADMIN_ACCESS_TOKEN</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_BACKEND_HOST</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_BACKEND_PORT</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_CORS_ORIGINS</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_DISABLE_BACKGROUND_JOBS</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_GRAPHQL_PLAYGROUND_ENABLED</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_IMPORTER_TRAKT_CLIENT_ID</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_IS_DEMO_INSTANCE</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_MAX_FILE_SIZE_MB</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_OIDC_CLIENT_ID</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    client_id</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_OIDC_CLIENT_SECRET</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_OIDC_ISSUER_URL</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # The pro key assigned to the user.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_PRO_KEY</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_PROGRESS_UPDATE_THRESHOLD</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar SERVER_SLEEP_BEFORE_STARTUP_SECONDS</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_SMTP_MAILBOX</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    mailbox</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;Ryot &lt;no-reply@mailer.io&gt;&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_SMTP_PASSWORD</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_SMTP_SERVER</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar SERVER_SMTP_USER</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar USERS_ALLOW_REGISTRATION</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar USERS_DISABLE_LOCAL_AUTH</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # The secret used for generating JWT tokens.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar USERS_JWT_SECRET</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  jwt_secret</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # @envvar USERS_TOKEN_VALID_FOR_DAYS</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar VIDEO_GAMES_IGDB_IMAGE_SIZE</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar VIDEO_GAMES_TWITCH_CLIENT_ID</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    client_id</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # @envvar VIDEO_GAMES_TWITCH_CLIENT_SECRET</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    client_secret</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;</span></span>
<span class="line"></span>
