...
- Keep operation input/output schemas in `backend/operations/schemas.ts`, outside sandbox modules. Workflow consumers import `Schema` from `@ryot/sandbox-sdk/workflow`.
