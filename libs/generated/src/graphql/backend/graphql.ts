...
export type GenreDetails = {
  contents: Array<MediaSearchItemWithLot>;
...
export type GenreDetailsQuery = { genreDetails: { details: { id: number, name: string, numItems?: number | null }, contents: Array<{ metadataLot?: MetadataLot | null, details: { identifier: string, title: string, image?: string | null, publishYear?: number | null } }> } };
