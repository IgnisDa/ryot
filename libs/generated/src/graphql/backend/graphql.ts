...
export type GetOrFetchEntityTranslationsMutationVariables = Exact<{
  input: EntityWithLotInput;
}>;


export type GetOrFetchEntityTranslationsMutation = { getOrFetchEntityTranslations: { response: Array<{ value?: string | null, variant: EntityTranslationVariant }> } };
...
export type UserPersonDetailsQuery = { userPersonDetails: { response: { hasInteracted: boolean, averageRating?: string | null, collections: Array<{ id: string, details: { createdOn: string, information?: any | null, collectionId: string, lastUpdatedOn: string, creatorUserId: string, collectionName: string } }>, reviews: Array<{ id: string, rating?: string | null, postedOn: string, isSpoiler: boolean, visibility: Visibility, textOriginal?: string | null, textRendered?: string | null, seenItemsAssociatedWith: Array<string>, postedBy: { id: string, name: string }, comments: Array<{ id: string, text: string, likedBy: Array<string>, createdOn: string, user: { id: string, name: string } }>, showExtraInformation?: { season?: number | null, episode?: number | null } | null, podcastExtraInformation?: { episode?: number | null } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null }> } } };
...
export const GetOrFetchEntityTranslationsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GetOrFetchEntityTranslations"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"EntityWithLotInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getOrFetchEntityTranslations"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"response"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"variant"}}]}}]}}]}}]} as unknown as DocumentNode<GetOrFetchEntityTranslationsMutation, GetOrFetchEntityTranslationsMutationVariables>;
