...
export type CoreDetailsQuery = { coreDetails: { timezone: string, authorName: string, repositoryLink: string, docsLink: string, pageLimit: number, tokenValidForDays: number, oidcEnabled: boolean } };
...
export type UserPersonDetailsQuery = { userPersonDetails: { collections: Array<{ id: number, name: string, userId: number }>, reviews: Array<{ id: number, rating?: string | null, textOriginal?: string | null, textRendered?: string | null, spoiler: boolean, visibility: Visibility, postedOn: string, postedBy: { id: number, name: string }, comments: Array<{ id: string, text: string, createdOn: string, likedBy: Array<number>, user: { id: number, name: string } }>, showExtraInformation?: { episode: number, season: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { chapter?: number | null, volume?: number | null } | null }>, reminder?: { remindOn: string, message: string } | null } };
...
export type UserCollectionsListQuery = { userCollectionsList: Array<{ id: number, name: string, description?: string | null, count: number, creatorUserId: number, creatorUsername: string, informationTemplate?: Array<{ name: string, description: string, lot: CollectionExtraInformationLot }> | null }> };
...
export type CollectionPartFragment = { id: number, name: string, userId: number };
