...
export type CreatorDetails = {
  ...
  workedOn: Array<PartialMetadata>;
};
...
export type CreatorSortInput = {
  by?: CreatorSortBy;
  order?: GraphqlSortOrder;
};

export type CreatorsListInput = {
  search: SearchInput;
...
export type UserGeneralPreferences = {
  ...
  numGenresDisplay: Scalars['Int']['output'];
...
export type UserToExerciseExtraInformation = {
  ...
  lifetimeStats: WorkoutTotalMeasurement;
...
export type CreateCustomExerciseMutation = { createCustomExercise: { id: number } };
...
export type DeployRecalculateCalendarEventsJobMutationVariables = Exact<{ [key: string]: never; }>;


export type DeployRecalculateCalendarEventsJobMutation = { deployRecalculateCalendarEventsJob: boolean };
...
export type CreatorDetailsQuery = { creatorDetails: { sourceUrl?: string | null, details: { id: number, name: string, source: MetadataSource, description?: string | null, birthDate?: string | null, deathDate?: string | null, place?: string | null, website?: string | null, gender?: string | null, displayImages: Array<string> }, contents: Array<{ name: string, items: Array<{ metadataId?: number | null, title: string, image?: string | null }> }>, workedOn: Array<{ lot: MetadataLot, source: MetadataSource, identifier: string, title: string, image?: string | null, metadataId?: number | null }> } };
...
export type ExerciseDetailsQuery = { exerciseDetails: { name: string, lot: ExerciseLot, source: ExerciseSource, level: ExerciseLevel, force?: ExerciseForce | null, mechanic?: ExerciseMechanic | null, equipment?: ExerciseEquipment | null, attributes: { instructions: Array<string>, images: Array<string>, muscles: Array<ExerciseMuscle> } } };
...
export type ExercisesListQuery = { exercisesList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: number, name: string, lot: ExerciseLot, image?: string | null, muscle?: ExerciseMuscle | null, numTimesPerformed?: number | null }> } };
...
export type MediaListQuery = { mediaList: { details: { total: number, nextPage?: number | null }, items: Array<{ averageRating?: number | null, data: { identifier: string, title: string, image?: string | null, publishYear?: number | null } }> } };
...
export type MediaMainDetailsQuery = { mediaDetails: { title: string, description?: string | null, identifier: string, lot: MetadataLot, source: MetadataSource, isNsfw: boolean, providerRating?: number | null, publishYear?: number | null, publishDate?: string | null, productionStatus: string, genres: Array<string>, sourceUrl?: string | null, group?: { id: number, name: string, part: number } | null } };
...
export type MetadataGroupDetailsQuery = { metadataGroupDetails: { sourceUrl?: string | null, details: { id: number, title: string, lot: MetadataLot, source: MetadataSource, displayImages: Array<string>, parts: number }, contents: Array<{ lot: MetadataLot, source: MetadataSource, identifier: string, title: string, image?: string | null, metadataId?: number | null }> } };
...
export type ReviewQuery = { review: { rating?: number | null, text?: string | null, visibility: Visibility, spoiler: boolean, showSeason?: number | null, showEpisode?: number | null, podcastEpisode?: number | null } };
...
export type UserCreatorDetailsQuery = { userCreatorDetails: { reviews: Array<{ id: number, rating?: number | null, text?: string | null, spoiler: boolean, visibility: Visibility, postedOn: Date, postedBy: { id: number, name: string }, comments: Array<{ id: string, text: string, createdOn: Date, likedBy: Array<number>, user: { id: number, name: string } }> }> } };
...
export type UserExerciseDetailsQuery = { userExerciseDetails?: { history: Array<{ workoutId: string, workoutName: string, workoutTime: Date, sets: Array<{ lot: SetLot, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } }> }>, details: { exerciseId: number, numTimesPerformed: number, lastUpdatedOn: Date, extraInformation: { lifetimeStats: { weight: number, reps: number, distance: number, duration: number, personalBestsAchieved: number }, personalBests: Array<{ lot: WorkoutSetPersonalBest, sets: Array<{ workoutId: string, setIdx: number, data: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> }> } } } | null };

export type UserIntegrationsQueryVariables = Exact<{ [key: string]: never; }>;


export type UserIntegrationsQuery = { userIntegrations: Array<{ id: number, lot: UserIntegrationLot, description: string, timestamp: Date, slug?: string | null }> };
...
export type UserMeasurementsListQuery = { userMeasurementsList: Array<{ timestamp: Date, name?: string | null, comment?: string | null, stats: { weight?: number | null, bodyMassIndex?: number | null, totalBodyWater?: number | null, muscle?: number | null, leanBodyMass?: number | null, bodyFat?: number | null, boneMass?: number | null, visceralFat?: number | null, waistCircumference?: number | null, waistToHeightRatio?: number | null, hipCircumference?: number | null, waistToHipRatio?: number | null, chestCircumference?: number | null, thighCircumference?: number | null, bicepsCircumference?: number | null, neckCircumference?: number | null, bodyFatCaliper?: number | null, chestSkinfold?: number | null, abdominalSkinfold?: number | null, thighSkinfold?: number | null, basalMetabolicRate?: number | null, totalDailyEnergyExpenditure?: number | null, calories?: number | null, custom?: any | null } }> };
...
export type UserWorkoutListQuery = { userWorkoutList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: string, name?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, exercises: Array<{ numSets: number, name: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> } }> } };
...
export type WorkoutDetailsQuery = { workoutDetails: { name: string, comment?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, exercises: Array<{ numSets: number, name: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> }, information: { assets: { images: Array<string>, videos: Array<string> }, exercises: Array<{ id: number, name: string, lot: ExerciseLot, notes: Array<string>, restTime?: number | null, total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, assets: { images: Array<string>, videos: Array<string> }, sets: Array<{ lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } }> }> } } };
...
export type SeenPartFragment = { id: number, progress: number, state: SeenState, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: Date, numTimesUpdated?: number | null, showInformation?: { episode: number, season: number } | null, podcastInformation?: { episode: number } | null };

export type PartialMetadataPartFragment = { lot: MetadataLot, source: MetadataSource, identifier: string, title: string, image?: string | null, metadataId?: number | null };

export type WorkoutTotalMeasurementPartFragment = { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number };

export type EntityAssetsPartFragment = { images: Array<string>, videos: Array<string> };

export type WorkoutSetStatisticPartFragment = { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null };

export type WorkoutSummaryPartFragment = { total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, exercises: Array<{ numSets: number, name: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> };
...
export const DeployRecalculateCalendarEventsJobDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeployRecalculateCalendarEventsJob"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deployRecalculateCalendarEventsJob"}}]}}]} as unknown as DocumentNode<DeployRecalculateCalendarEventsJobMutation, DeployRecalculateCalendarEventsJobMutationVariables>;
...
export const UserWorkoutListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UserWorkoutList"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userWorkoutList"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"details"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"nextPage"}}]}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"startTime"}},{"kind":"Field","name":{"kind":"Name","value":"endTime"}},{"kind":"Field","name":{"kind":"Name","value":"summary"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkoutSummaryPart"}}]}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkoutTotalMeasurementPart"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"WorkoutTotalMeasurement"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"personalBestsAchieved"}},{"kind":"Field","name":{"kind":"Name","value":"weight"}},{"kind":"Field","name":{"kind":"Name","value":"reps"}},{"kind":"Field","name":{"kind":"Name","value":"distance"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkoutSetStatisticPart"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"WorkoutSetStatistic"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"distance"}},{"kind":"Field","name":{"kind":"Name","value":"reps"}},{"kind":"Field","name":{"kind":"Name","value":"weight"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkoutSummaryPart"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"WorkoutSummary"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkoutTotalMeasurementPart"}}]}},{"kind":"Field","name":{"kind":"Name","value":"exercises"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"numSets"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"lot"}},{"kind":"Field","name":{"kind":"Name","value":"bestSet"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"statistic"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkoutSetStatisticPart"}}]}},{"kind":"Field","name":{"kind":"Name","value":"lot"}},{"kind":"Field","name":{"kind":"Name","value":"personalBests"}}]}}]}}]}}]} as unknown as DocumentNode<UserWorkoutListQuery, UserWorkoutListQueryVariables>;
