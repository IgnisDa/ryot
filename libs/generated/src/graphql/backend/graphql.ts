...
export type UserToExerciseRestTimerSettingsExtraInformation = {
...
export type UserToExerciseSettingsExtraInformation = {
  restTimer: UserToExerciseRestTimerSettingsExtraInformation;
};
