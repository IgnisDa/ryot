...
export type CreateReviewCommentInput = {
  ...
  likeComment?: InputMaybe<Scalars['Boolean']['input']>;
...
export type MutationRoot = {
  ...
  createReviewComment: Scalars['String']['output'];
...
export type CreateReviewCommentMutation = { createReviewComment: string };
...
export type CreatorDetailsQuery = { creatorDetails: { details: { id: number, name: string, image?: string | null }, contents: Array<{ name: string, items: Array<{ lot: MetadataLot, details: { identifier: string, title: string, image?: string | null, publishYear?: number | null } }> }> } };
...
export type LatestUserSummaryQuery = { latestUserSummary: { calculatedOn: Date, fitness: { measurementsRecorded: number, workoutsRecorded: number }, media: { reviewsPosted: number, creatorsInteractedWith: number, manga: { chapters: number, read: number }, books: { pages: number, read: number }, movies: { runtime: number, watched: number }, anime: { episodes: number, watched: number }, podcasts: { runtime: number, played: number, playedEpisodes: number }, videoGames: { played: number }, shows: { runtime: number, watchedEpisodes: number, watchedSeasons: number, watched: number }, audioBooks: { runtime: number, played: number } } } };
...
export type UserCreatorDetailsQuery = { userCreatorDetails: { reviews: Array<{ id: number, rating?: any | null, text?: string | null, spoiler: boolean, visibility: Visibility, postedOn: Date, postedBy: { id: number, name: string }, comments: Array<{ id: string, text: string, createdOn: Date, likedBy: Array<number>, user: { id: number, username: string } }> }> } };
