...
export type CoreDetailsQuery = { coreDetails: { timezone: string, docsLink: string, pageLimit: number, authorName: string, oidcEnabled: boolean, repositoryLink: string, localAuthDisabled: boolean, tokenValidForDays: number } };
