...
export type DailyUserActivity = {
  ...
  totalDuration: Scalars['Decimal']['output'];
...
export type DailyUserActivitiesQuery = { dailyUserActivities: { groupedBy: DailyUserActivitiesResponseGroupedBy, totalCount: number, mostActiveHour?: number | null, items: Array<{ date: string, totalCounts: number, reviewCounts: number, totalDuration: string, workoutCounts: number, measurementCounts: number, metadataCounts: Array<{ lot: MediaLot, count: number }> }> } };
