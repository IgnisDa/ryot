...
export type CollectionToEntityDetailsPartFragment = { id: string, details: { createdOn: string, lastUpdatedOn: string, information?: any | null, collectionId: string, collectionName: string } };
