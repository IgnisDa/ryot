...
export type ProcessAccessLinkMutation = { processAccessLink: { __typename: 'ProcessAccessLinkError', error: ProcessAccessLinkErrorVariant } | { __typename: 'ProcessAccessLinkResponse', apiKey: string, tokenValidForDays: number } };
...
export type CoreDetailsQuery = { coreDetails: { isPro: boolean, version: string, docsLink: string, pageLimit: number, websiteUrl: string, authorName: string, oidcEnabled: boolean, signupAllowed: boolean, repositoryLink: string, localAuthDisabled: boolean, fileStorageEnabled: boolean, tokenValidForDays: number } };
...
export type UserIntegrationsQuery = { userIntegrations: Array<{ id: string, lot: IntegrationLot, source: IntegrationSource, createdOn: string, isDisabled?: boolean | null, maximumProgress: string, minimumProgress: string, lastTriggeredOn?: string | null, syncToOwnedCollection?: boolean | null }> };
