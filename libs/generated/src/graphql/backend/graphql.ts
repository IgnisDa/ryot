...
export type UserCollectionsListQuery = { userCollectionsList: Array<{ id: number, name: string, createdOn: Date, visibility: Visibility, numItems: number }> };
...
export type UserMetadataGroupDetailsQuery = { userMetadataGroupDetails: { collections: Array<{ id: number, name: string }> } };
