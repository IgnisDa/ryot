...
export type RestTimersSettings = {
  dropSet?: Maybe<Scalars['Int']['output']>;
  failureSet?: Maybe<Scalars['Int']['output']>;
  normalSet?: Maybe<Scalars['Int']['output']>;
  warmupSet?: Maybe<Scalars['Int']['output']>;
};
...
export type UserExercisesPreferences = {
  restTimers: RestTimersSettings;
...
export type UserFitnessPreferences = {
  exercises: UserExercisesPreferences;
...
export type UserWorkoutDetailsQuery = { userWorkoutDetails: { collections: Array<{ id: string, name: string, userId: string }>, details: { id: string, name: string, endTime: string, duration: number, startTime: string, templateId?: string | null, repeatedFrom?: string | null, summary: { total?: { personalBestsAchieved: number, weight: string, reps: string, distance: string, duration: string, restTime: number } | null, exercises: Array<{ lot?: ExerciseLot | null, name: string, numSets: number, bestSet?: { lot: SetLot, personalBests?: Array<WorkoutSetPersonalBest> | null, statistic: { duration?: string | null, distance?: string | null, reps?: string | null, weight?: string | null, oneRm?: string | null, pace?: string | null, volume?: string | null } } | null }> }, information: { comment?: string | null, assets?: { images: Array<string>, videos: Array<string> } | null, exercises: Array<{ lot: ExerciseLot, name: string, notes: Array<string>, restTime?: number | null, identifier: string, supersetWith: Array<number>, total?: { personalBestsAchieved: number, weight: string, reps: string, distance: string, duration: string, restTime: number } | null, assets?: { images: Array<string>, videos: Array<string> } | null, sets: Array<{ lot: SetLot, note?: string | null, restTime?: number | null, confirmedAt?: string | null, personalBests?: Array<WorkoutSetPersonalBest> | null, statistic: { duration?: string | null, distance?: string | null, reps?: string | null, weight?: string | null, oneRm?: string | null, pace?: string | null, volume?: string | null } }> }> } } } };
...
export type RestTimersPartFragment = { dropSet?: number | null, warmupSet?: number | null, normalSet?: number | null, failureSet?: number | null };
...
export const RestTimersPartFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"RestTimersPart"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"RestTimersSettings"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dropSet"}},{"kind":"Field","name":{"kind":"Name","value":"warmupSet"}},{"kind":"Field","name":{"kind":"Name","value":"normalSet"}},{"kind":"Field","name":{"kind":"Name","value":"failureSet"}}]}}]} as unknown as DocumentNode<RestTimersPartFragment, unknown>;
