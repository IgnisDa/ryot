...
export type UserCollectionsListQuery = { userCollectionsList: Array<{ id: number, name: string, description?: string | null, count: number, userId: number, username: string }> };
