...
export type GeneratePasswordChangeSessionMutationVariables = Exact<{ [key: string]: never; }>;


export type GeneratePasswordChangeSessionMutation = { generatePasswordChangeSession: boolean };

export type GetPasswordChangeUrlMutationVariables = Exact<{
  input: GetPasswordChangeUrlInput;
}>;


export type GetPasswordChangeUrlMutation = { getPasswordChangeUrl: { userId: string, passwordChangeUrl: string } };
...
export type MetadataGroupSearchQuery = { metadataGroupSearch: { cacheId: string, response: { items: Array<string>, details: { total: number, nextPage?: number | null } } } };
...
export type MetadataSearchQuery = { metadataSearch: { cacheId: string, response: { items: Array<string>, details: { total: number, nextPage?: number | null } } } };
...
export type PeopleSearchQuery = { peopleSearch: { cacheId: string, response: { items: Array<string>, details: { total: number, nextPage?: number | null } } } };
...
export const GeneratePasswordChangeSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GeneratePasswordChangeSession"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generatePasswordChangeSession"}}]}}]} as unknown as DocumentNode<GeneratePasswordChangeSessionMutation, GeneratePasswordChangeSessionMutationVariables>;
export const GetPasswordChangeUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GetPasswordChangeUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GetPasswordChangeUrlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getPasswordChangeUrl"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"passwordChangeUrl"}}]}}]}}]} as unknown as DocumentNode<GetPasswordChangeUrlMutation, GetPasswordChangeUrlMutationVariables>;
