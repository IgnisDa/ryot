...
export type UserGeneralDashboardCommonPreferencesPartFragment = { index: number, isHidden: boolean, settings: { numElements: number } };

export type UserGeneralDashboardNoSettingsPreferencesPartFragment = { index: number, isHidden: boolean };
