...
export type CoreDetailsQuery = { coreDetails: { isPro: boolean, version: string, timezone: string, docsLink: string, pageLimit: number, websiteUrl: string, authorName: string, oidcEnabled: boolean, repositoryLink: string, localAuthDisabled: boolean, tokenValidForDays: number } };
