...
export type ReviewItem = {
  animeEpisode?: Maybe<Scalars['Int']['output']>;
  comments: Array<ImportOrExportItemReviewComment>;
  id: Scalars['Int']['output'];
  mangaChapter?: Maybe<Scalars['Int']['output']>;
...
export type Seen = {
  animeInformation?: Maybe<SeenAnimeExtraInformation>;
  finishedOn?: Maybe<Scalars['NaiveDate']['output']>;
  id: Scalars['Int']['output'];
  lastUpdatedOn: Scalars['DateTime']['output'];
  mangaInformation?: Maybe<SeenMangaExtraInformation>;
  metadataId: Scalars['Int']['output'];
...
export type UserMediaDetailsQuery = { userMediaDetails: { averageRating?: string | null, unitsConsumed?: number | null, isMonitored: boolean, seenBy: number, collections: Array<{ id: number, name: string }>, inProgress?: { id: number, progress: number, state: SeenState, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, numTimesUpdated: number, showInformation?: { episode: number, season: number } | null, podcastInformation?: { episode: number } | null, animeInformation?: { episode?: number | null } | null, mangaInformation?: { chapter?: number | null } | null } | null, history: Array<{ id: number, progress: number, state: SeenState, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, numTimesUpdated: number, showInformation?: { episode: number, season: number } | null, podcastInformation?: { episode: number } | null, animeInformation?: { episode?: number | null } | null, mangaInformation?: { chapter?: number | null } | null }>, reviews: Array<{ id: number, rating?: string | null, textOriginal?: string | null, textRendered?: string | null, spoiler: boolean, visibility: Visibility, showSeason?: number | null, showEpisode?: number | null, podcastEpisode?: number | null, animeEpisode?: number | null, mangaChapter?: number | null, postedOn: string, postedBy: { id: number, name: string }, comments: Array<{ id: string, text: string, createdOn: string, likedBy: Array<number>, user: { id: number, name: string } }> }>, reminder?: { remindOn: string, message: string } | null, ownership?: { markedOn: string, ownedOn?: string | null } | null, nextEntry?: { season?: number | null, episode?: number | null, chapter?: number | null } | null } };
...
export type SeenPartFragment = { id: number, progress: number, state: SeenState, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, numTimesUpdated: number, showInformation?: { episode: number, season: number } | null, podcastInformation?: { episode: number } | null, animeInformation?: { episode?: number | null } | null, mangaInformation?: { chapter?: number | null } | null };
