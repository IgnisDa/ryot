...
export type GenreDetails = {
  contents: Array<MediaSearchItem>;
...
export type UserToEntity = {
  ...
  exerciseId?: Maybe<Scalars['Int']['output']>;
  id: Scalars['Int']['output'];
  lastUpdatedOn: Scalars['DateTime']['output'];
  metadataId?: Maybe<Scalars['Int']['output']>;
...
export type ExerciseDetailsQuery = { exerciseDetails: { name: string, lot: ExerciseLot, source: ExerciseSource, level: ExerciseLevel, force?: ExerciseForce | null, mechanic?: ExerciseMechanic | null, equipment?: ExerciseEquipment | null, muscles: Array<ExerciseMuscle>, attributes: { instructions: Array<string>, images: Array<string> } } };
...
export type ExercisesListQuery = { exercisesList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: number, name: string, lot: ExerciseLot, image?: string | null, muscle?: ExerciseMuscle | null, numTimesInteracted?: number | null }> } };
...
export type GenreDetailsQuery = { genreDetails: { details: { id: number, name: string, numItems?: number | null }, contents: Array<{ identifier: string, title: string, image?: string | null, publishYear?: number | null }> } };
...
export type LatestUserSummaryQuery = { latestUserSummary: { calculatedOn: Date, fitness: { measurementsRecorded: number, workoutsRecorded: number, exercisesInteractedWith: number }, media: { reviewsPosted: number, creatorsInteractedWith: number, mediaInteractedWith: number, manga: { chapters: number, read: number }, books: { pages: number, read: number }, movies: { runtime: number, watched: number }, anime: { episodes: number, watched: number }, podcasts: { runtime: number, played: number, playedEpisodes: number }, visualNovels: { played: number, runtime: number }, videoGames: { played: number }, shows: { runtime: number, watchedEpisodes: number, watchedSeasons: number, watched: number }, audioBooks: { runtime: number, played: number } } } };
...
export type MediaMainDetailsQuery = { mediaDetails: { title: string, description?: string | null, identifier: string, lot: MetadataLot, source: MetadataSource, isNsfw: boolean, providerRating?: string | null, publishYear?: number | null, publishDate?: string | null, productionStatus: string, sourceUrl?: string | null, genres: Array<{ id: number, name: string }>, group?: { id: number, name: string, part: number } | null } };
...
export type UserMetadataGroupDetailsQuery = { userMetadataGroupDetails: { reviews: Array<{ id: number, rating?: string | null, text?: string | null, spoiler: boolean, visibility: Visibility, showSeason?: number | null, showEpisode?: number | null, podcastEpisode?: number | null, postedOn: Date, postedBy: { id: number, name: string }, comments: Array<{ id: string, text: string, createdOn: Date, likedBy: Array<number>, user: { id: number, name: string } }> }>, collections: Array<{ id: number, name: string }> } };
...
export type UserWorkoutListQuery = { userWorkoutList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: string, name?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: string, reps: number, distance: string, duration: string }, exercises: Array<{ numSets: number, name: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: string | null, distance?: string | null, reps?: number | null, weight?: string | null } } }> } }> } };
...
export type WorkoutDetailsQuery = { workoutDetails: { name: string, comment?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: string, reps: number, distance: string, duration: string }, exercises: Array<{ numSets: number, name: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: string | null, distance?: string | null, reps?: number | null, weight?: string | null } } }> }, information: { assets: { images: Array<string>, videos: Array<string> }, exercises: Array<{ id: number, name: string, lot: ExerciseLot, notes: Array<string>, restTime?: number | null, total: { personalBestsAchieved: number, weight: string, reps: number, distance: string, duration: string }, assets: { images: Array<string>, videos: Array<string> }, sets: Array<{ lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: string | null, distance?: string | null, reps?: number | null, weight?: string | null } }> }> } } };
...
export type WorkoutTotalMeasurementPartFragment = { personalBestsAchieved: number, weight: string, reps: number, distance: string, duration: string };

export type EntityAssetsPartFragment = { images: Array<string>, videos: Array<string> };

export type WorkoutSetStatisticPartFragment = { duration?: string | null, distance?: string | null, reps?: number | null, weight?: string | null };
