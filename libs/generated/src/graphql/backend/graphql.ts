...
export type ExercisesListQuery = { exercisesList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: number, name: string, lot: ExerciseLot, numTimesPerformed?: number | null, attributes: { images: Array<string>, muscles: Array<ExerciseMuscle> } }> } };
