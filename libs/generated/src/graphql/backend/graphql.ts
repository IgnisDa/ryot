...
export type QueryRootMetadataSourcesForLotArgs = {
  lot: MetadataLot;
};
...
export type MetadataSourcesForLotQueryVariables = Exact<{
  lot: MetadataLot;
}>;


export type MetadataSourcesForLotQuery = { metadataSourcesForLot: Array<MediaSource> };
...
export type PeopleSearchQuery = { peopleSearch: { details: { total: number, nextPage?: number | null }, items: Array<{ hasInteracted: boolean, databaseId?: number | null, item: { identifier: string, name: string, image?: string | null, birthYear?: number | null } }> } };
...
export const MetadataSourcesForLotDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MetadataSourcesForLot"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"lot"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MetadataLot"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"metadataSourcesForLot"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"lot"},"value":{"kind":"Variable","name":{"kind":"Name","value":"lot"}}}]}]}}]} as unknown as DocumentNode<MetadataSourcesForLotQuery, MetadataSourcesForLotQueryVariables>;
