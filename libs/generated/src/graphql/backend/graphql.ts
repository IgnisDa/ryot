...
export type CoreFeatureEnabled = {
  general: Array<GeneralCoreFeatureEnabled>;
...
export type CoreEnabledFeaturesQuery = { coreEnabledFeatures: { general: Array<{ name: string, enabled: boolean }>, metadata: Array<{ name: MetadataLot, enabled: boolean }> } };
