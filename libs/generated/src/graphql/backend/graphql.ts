...
export type UserUpcomingCalendarEventsQuery = { userUpcomingCalendarEvents: Array<{ date: string, metadataId: string, metadataImage?: string | null, calendarEventId: string, showExtraInformation?: { episode: number, season: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null }> };
...
export type UserCalendarEventsQuery = { userCalendarEvents: Array<{ date: string, events: Array<{ date: string, metadataId: string, metadataImage?: string | null, calendarEventId: string, showExtraInformation?: { episode: number, season: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null }> }> };
...
export type CalendarEventPartFragment = { date: string, metadataId: string, metadataImage?: string | null, calendarEventId: string, showExtraInformation?: { episode: number, season: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null };
...
export type MinimalUserAnalyticsQuery = { userAnalytics: { response: { activities: { items: Array<{ day: string, totalCount: number, totalDuration: number, totalBookPages: number, totalReviewCount: number, totalMetadataCount: number, totalShowDuration: number, totalMovieDuration: number, totalMusicDuration: number, totalWorkoutReps: number, totalWorkoutWeight: number, totalWorkoutDistance: number, totalWorkoutRestTime: number, totalWorkoutDuration: number, totalPodcastDuration: number, totalVideoGameDuration: number, totalAudioBookDuration: number, totalVisualNovelDuration: number, totalPersonReviewCount: number, totalMetadataReviewCount: number, totalWorkoutPersonalBests: number, totalCollectionReviewCount: number, totalMetadataGroupReviewCount: number, userMeasurementCount: number, bookCount: number, showCount: number, movieCount: number, musicCount: number, animeCount: number, mangaCount: number, workoutCount: number, podcastCount: number, audioBookCount: number, videoGameCount: number, comicBookCount: number, visualNovelCount: number, totalComicBookPages: number }> } } } };
