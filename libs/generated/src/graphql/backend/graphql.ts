...
export type UserDetailsQuery = { userDetails: { __typename: 'User', id: number, lot: UserLot, name: string, isDemo?: boolean | null } | { __typename: 'UserDetailsError' } };
...
export type GetOidcRedirectUrlQuery = { getOidcRedirectUrl: { url: string, csrf: string } };
...
export type GetOidcTokenQuery = { getOidcToken: string };
