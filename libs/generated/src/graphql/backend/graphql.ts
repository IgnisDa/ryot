...
export type MutationRoot = {
  ...
  generateLogDownloadToken: Scalars['String']['output'];
...
export type GenerateLogDownloadTokenMutationVariables = Exact<{ [key: string]: never; }>;


export type GenerateLogDownloadTokenMutation = { generateLogDownloadToken: string };
...
export const GenerateLogDownloadTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GenerateLogDownloadToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generateLogDownloadToken"}}]}}]} as unknown as DocumentNode<GenerateLogDownloadTokenMutation, GenerateLogDownloadTokenMutationVariables>;
