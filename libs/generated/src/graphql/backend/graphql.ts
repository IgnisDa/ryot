...
export type GeneralFeatures = {
  ...
  signupAllowed: GeneralFeatureEnabled;
};
...
export type CoreEnabledFeaturesQuery = { coreEnabledFeatures: { fileStorage: { enabled: boolean }, signupAllowed: { enabled: boolean } } };
