...
export type GoodreadsImportInput = {
  data: Scalars['String'];
};
...
export enum ImportFailStep {
  ...
  ReviewTransformation = 'REVIEW_TRANSFORMATION'
}
...
export type MediaTrackerImportInput = {
