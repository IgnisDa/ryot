...
export type UserMetadataGroupsListQuery = { userMetadataGroupsList: { items: Array<string>, details: { total: number, nextPage?: number | null } } };
...
export type UserPeopleListQuery = { userPeopleList: { items: Array<string>, details: { total: number, nextPage?: number | null } } };
...
export type UserExercisesListQuery = { userExercisesList: { items: Array<string>, details: { total: number, nextPage?: number | null } } };
