...
export type MediaListQuery = { mediaList: { total: number, nextPage?: number | null, items: Array<{ averageRating?: any | null, data: { identifier: string, title: string, images: Array<string>, publishYear?: number | null } }> } };
...
export type PartialCollectionsQuery = { collections: Array<{ collectionDetails: { id: number, name: string, numItems: number } }> };
