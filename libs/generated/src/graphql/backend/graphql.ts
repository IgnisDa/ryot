...
export type MutationRoot = {
  ...
  associateReviewWithSeenItem: Scalars['Boolean']['output'];
...
export type MutationRootAssociateReviewWithSeenItemArgs = {
  reviewId: Scalars['String']['input'];
...
export type AssociateReviewWithSeenItemMutationVariables = Exact<{
  reviewId: Scalars['String']['input'];
  seenId: Scalars['String']['input'];
}>;


export type AssociateReviewWithSeenItemMutation = { associateReviewWithSeenItem: boolean };
...
export type SeenPartFragment = { id: string, name?: string | null, state: SeenState, progress: string, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, manualTimeSpent?: string | null, numTimesUpdated: number, providerWatchedOn?: string | null, showExtraInformation?: { episode: number, season: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { chapter?: string | null, volume?: number | null } | null };
...
export const AssociateReviewWithSeenItemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"associateReviewWithSeenItem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"reviewId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"seenId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"associateReviewWithSeenItem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"reviewId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"reviewId"}}},{"kind":"Argument","name":{"kind":"Name","value":"seenId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seenId"}}}]}]}}]} as unknown as DocumentNode<AssociateReviewWithSeenItemMutation, AssociateReviewWithSeenItemMutationVariables>;
