...
export type CoreDetailsQuery = { coreDetails: { timezone: string, authorName: string, repositoryLink: string, docsLink: string, itemDetailsHeight: number, pageLimit: number, tokenValidForDays: number } };
