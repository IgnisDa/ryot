...
export type MutationRoot = {
  ...
  deleteUserImportReport: Scalars['Boolean']['output'];
...
export type MutationRootDeleteUserImportReportArgs = {
  importReportId: Scalars['String']['input'];
};
...
export type CreateCustomMetadataGroupMutationVariables = Exact<{
  input: CreateCustomMetadataGroupInput;
}>;


export type CreateCustomMetadataGroupMutation = { createCustomMetadataGroup: { id: string } };

export type UpdateCustomMetadataGroupMutationVariables = Exact<{
  input: UpdateCustomMetadataGroupInput;
}>;


export type UpdateCustomMetadataGroupMutation = { updateCustomMetadataGroup: boolean };

export type CreateCustomPersonMutationVariables = Exact<{
  input: CreateCustomPersonInput;
}>;


export type CreateCustomPersonMutation = { createCustomPerson: { id: string } };

export type UpdateCustomPersonMutationVariables = Exact<{
  input: UpdateCustomPersonInput;
}>;


export type UpdateCustomPersonMutation = { updateCustomPerson: boolean };
...
export type CreateOrUpdateUserMeasurementMutationVariables = Exact<{
  input: UserMeasurementInput;
}>;


export type CreateOrUpdateUserMeasurementMutation = { createOrUpdateUserMeasurement: string };
...
export type DeleteUserImportReportMutationVariables = Exact<{
  importReportId: Scalars['String']['input'];
}>;


export type DeleteUserImportReportMutation = { deleteUserImportReport: boolean };
...
export type DeployUpdateMediaTranslationsJobMutationVariables = Exact<{
  input: MediaTranslationInput;
}>;


export type DeployUpdateMediaTranslationsJobMutation = { deployUpdateMediaTranslationsJob: boolean };
...
export type DeleteFilterPresetMutation = { deleteFilterPreset: boolean };

export type UpdateFilterPresetLastUsedMutationVariables = Exact<{
  filterPresetId: Scalars['UUID']['input'];
}>;


export type UpdateFilterPresetLastUsedMutation = { updateFilterPresetLastUsed: boolean };

export type GenerateLogDownloadUrlMutationVariables = Exact<{ [key: string]: never; }>;
...
export type UserUpcomingCalendarEventsQuery = { userUpcomingCalendarEvents: Array<{ date: string, metadataId: string, metadataImage?: string | null, calendarEventId: string, showExtraInformation?: { season: number, episode: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null }> };
...
export type UserCalendarEventsQuery = { userCalendarEvents: Array<{ date: string, events: Array<{ date: string, metadataId: string, metadataImage?: string | null, calendarEventId: string, showExtraInformation?: { season: number, episode: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null }> }> };
...
export type CollectionContentsQuery = { collectionContents: { cacheId: string, response: { totalItems: number, user: { id: string, name: string }, reviews: Array<{ id: string, rating?: string | null, postedOn: string, isSpoiler: boolean, visibility: Visibility, textOriginal?: string | null, textRendered?: string | null, seenItemsAssociatedWith: Array<string>, podcastExtraInformation?: { episode?: number | null } | null, postedBy: { id: string, name: string }, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null, showExtraInformation?: { season?: number | null, episode?: number | null } | null, comments: Array<{ id: string, text: string, likedBy: Array<string>, createdOn: string, user: { id: string, name: string } }> }>, details: { name: string, createdOn: string, description?: string | null }, results: { details: { nextPage?: number | null, totalItems: number }, items: Array<{ entityId: string, entityLot: EntityLot }> } } } };
...
export type MetadataGroupDetailsQuery = { metadataGroupDetails: { response: { contents: Array<string>, details: { id: string, lot: MediaLot, title: string, parts: number, source: MediaSource, isPartial?: boolean | null, sourceUrl?: string | null, identifier: string, description?: string | null, createdByUserId?: string | null, assets: { s3Images: Array<string>, s3Videos: Array<string>, remoteImages: Array<string>, remoteVideos: Array<{ url: string, source: EntityRemoteVideoSource }> } } } } };
...
export type MetadataGroupSearchQuery = { metadataGroupSearch: { response: { items: Array<string>, details: { nextPage?: number | null, totalItems: number } } } };
...
export type MetadataSearchQuery = { metadataSearch: { response: { items: Array<string>, details: { nextPage?: number | null, totalItems: number } } } };
...
export type PeopleSearchQuery = { peopleSearch: { response: { items: Array<string>, details: { nextPage?: number | null, totalItems: number } } } };
...
export type UserMetadataGroupDetailsQuery = { userMetadataGroupDetails: { response: { hasInteracted: boolean, averageRating?: string | null, reviews: Array<{ id: string, rating?: string | null, postedOn: string, isSpoiler: boolean, visibility: Visibility, textOriginal?: string | null, textRendered?: string | null, seenItemsAssociatedWith: Array<string>, podcastExtraInformation?: { episode?: number | null } | null, postedBy: { id: string, name: string }, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null, showExtraInformation?: { season?: number | null, episode?: number | null } | null, comments: Array<{ id: string, text: string, likedBy: Array<string>, createdOn: string, user: { id: string, name: string } }> }>, collections: Array<{ id: string, details: { createdOn: string, information?: any | null, collectionId: string, lastUpdatedOn: string, creatorUserId: string, collectionName: string } }> } } };
...
export type UserPersonDetailsQuery = { userPersonDetails: { response: { hasInteracted: boolean, averageRating?: string | null, reviews: Array<{ id: string, rating?: string | null, postedOn: string, isSpoiler: boolean, visibility: Visibility, textOriginal?: string | null, textRendered?: string | null, seenItemsAssociatedWith: Array<string>, podcastExtraInformation?: { episode?: number | null } | null, postedBy: { id: string, name: string }, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null, showExtraInformation?: { season?: number | null, episode?: number | null } | null, comments: Array<{ id: string, text: string, likedBy: Array<string>, createdOn: string, user: { id: string, name: string } }> }>, collections: Array<{ id: string, details: { createdOn: string, information?: any | null, collectionId: string, lastUpdatedOn: string, creatorUserId: string, collectionName: string } }> } } };
...
export type UserAnalyticsParametersQuery = { userAnalyticsParameters: { response: { endDate?: string | null, startDate?: string | null } } };
...
export type MetadataLookupQuery = { metadataLookup: { response:
...
export type UserEntityRecentlyConsumedQuery = { userEntityRecentlyConsumed: boolean };

export type MediaTranslationQueryVariables = Exact<{
  input: MediaTranslationInput;
}>;


export type MediaTranslationQuery = { mediaTranslation:
    | { __typename: 'MediaTranslationPending', status: MediaTranslationPendingStatus }
    | { __typename: 'MediaTranslationValue', value?: string | null }
   };
...
export type SeenShowExtraInformationPartFragment = { season: number, episode: number };
...
export type CalendarEventPartFragment = { date: string, metadataId: string, metadataImage?: string | null, calendarEventId: string, showExtraInformation?: { season: number, episode: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null };

export type SeenPartFragment = { id: string, state: SeenState, progress: string, reviewId?: string | null, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, manualTimeSpent?: string | null, numTimesUpdated: number, providersConsumedOn: Array<string>, showExtraInformation?: { season: number, episode: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null };
...
export type DailyUserActivityItemPartFragment = { day: string, bookCount: number, showCount: number, movieCount: number, musicCount: number, animeCount: number, totalCount: number, mangaCount: number, workoutCount: number, podcastCount: number, totalDuration: number, audioBookCount: number, videoGameCount: number, comicBookCount: number, totalBookPages: number, totalReviewCount: number, visualNovelCount: number, totalWorkoutReps: number, totalShowDuration: number, totalMetadataCount: number, totalMovieDuration: number, totalMusicDuration: number, totalWorkoutWeight: number, totalComicBookPages: number, userMeasurementCount: number, totalWorkoutDistance: number, totalWorkoutRestTime: number, totalWorkoutDuration: number, totalPodcastDuration: number, totalVideoGameDuration: number, totalAudioBookDuration: number, totalPersonReviewCount: number, totalVisualNovelDuration: number, totalMetadataReviewCount: number, totalWorkoutPersonalBests: number, totalCollectionReviewCount: number, totalMetadataGroupReviewCount: number };
...
export type PersonDetailsQuery = { personDetails: { response: { associatedMetadata: Array<{ name: string, items: Array<{ entityId: string, character?: string | null }> }>, associatedMetadataGroups: Array<{ name: string, items: Array<{ entityId: string, character?: string | null }> }>, details: { id: string, name: string, place?: string | null, source: MediaSource, gender?: string | null, website?: string | null, deathDate?: string | null, birthDate?: string | null, isPartial?: boolean | null, sourceUrl?: string | null, identifier: string, description?: string | null, alternateNames?: Array<string> | null, createdByUserId?: string | null, associatedEntityCount: number, associatedMetadataCount: number, associatedMetadataGroupsCount: number, assets: { s3Images: Array<string>, s3Videos: Array<string>, remoteImages: Array<string>, remoteVideos: Array<{ url: string, source: EntityRemoteVideoSource }> } } } } };
...
export type MinimalUserAnalyticsQuery = { userAnalytics: { response: { activities: { items: Array<{ day: string, bookCount: number, showCount: number, movieCount: number, musicCount: number, animeCount: number, totalCount: number, mangaCount: number, workoutCount: number, podcastCount: number, totalDuration: number, audioBookCount: number, videoGameCount: number, comicBookCount: number, totalBookPages: number, totalReviewCount: number, visualNovelCount: number, totalWorkoutReps: number, totalShowDuration: number, totalMetadataCount: number, totalMovieDuration: number, totalMusicDuration: number, totalWorkoutWeight: number, totalComicBookPages: number, userMeasurementCount: number, totalWorkoutDistance: number, totalWorkoutRestTime: number, totalWorkoutDuration: number, totalPodcastDuration: number, totalVideoGameDuration: number, totalAudioBookDuration: number, totalPersonReviewCount: number, totalVisualNovelDuration: number, totalMetadataReviewCount: number, totalWorkoutPersonalBests: number, totalCollectionReviewCount: number, totalMetadataGroupReviewCount: number }> } } } };

export type UserDetailsQueryVariables = Exact<{ [key: string]: never; }>;


export type UserDetailsQuery = { userDetails:
    | { __typename: 'UserDetails', id: string, lot: UserLot, name: string, isDisabled?: boolean | null, oidcIssuerId?: string | null, accessLinkId?: string | null, timesTwoFactorBackupCodesUsed?: number | null, extraInformation?: { isOnboardingTourCompleted: boolean, scheduledForWorkoutRevision: boolean } | null, preferences: { languages: { providers: Array<{ source: MediaSource, preferredLanguage: string }> }, general: { reviewScale: UserReviewScale, displayNsfw: boolean, landingPath: string, listPageSize: number, disableVideos: boolean, disableReviews: boolean, disableIntegrations: boolean, disableWatchProviders: boolean, disableNavigationAnimation: boolean, dashboard: Array<{ hidden: boolean, section: DashboardElementLot, numElements?: number | null, numDaysAhead?: number | null, deduplicateMedia?: boolean | null }>, watchProviders: Array<{ lot: MediaLot, values: Array<string> }> }, fitness: { exercises: { unitSystem: UserUnitSystem, setRestTimers: { drop?: number | null, warmup?: number | null, normal?: number | null, failure?: number | null } }, logging: { muteSounds: boolean, caloriesBurntUnit: string, promptForRestTimer: boolean, startTimerForDurationExercises: boolean }, measurements: { statistics: Array<{ name: string, unit?: string | null }> } }, featuresEnabled: { analytics: { enabled: boolean }, others: { calendar: boolean, collections: boolean }, fitness: { enabled: boolean, workouts: boolean, templates: boolean, measurements: boolean }, media: { enabled: boolean, groups: boolean, people: boolean, genres: boolean, specific: Array<MediaLot> } } } }
...
export type UserMetadataDetailsQuery = { userMetadataDetails: { response: { mediaReason?: Array<UserToMediaReason> | null, hasInteracted: boolean, averageRating?: string | null, seenByAllCount: number, seenByUserCount: number, history: Array<{ id: string, state: SeenState, progress: string, reviewId?: string | null, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, manualTimeSpent?: string | null, numTimesUpdated: number, providersConsumedOn: Array<string>, showExtraInformation?: { season: number, episode: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null }>, reviews: Array<{ id: string, rating?: string | null, postedOn: string, isSpoiler: boolean, visibility: Visibility, textOriginal?: string | null, textRendered?: string | null, seenItemsAssociatedWith: Array<string>, podcastExtraInformation?: { episode?: number | null } | null, postedBy: { id: string, name: string }, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null, showExtraInformation?: { season?: number | null, episode?: number | null } | null, comments: Array<{ id: string, text: string, likedBy: Array<string>, createdOn: string, user: { id: string, name: string } }> }>, nextEntry?: { season?: number | null, volume?: number | null, episode?: number | null, chapter?: string | null } | null, inProgress?: { id: string, state: SeenState, progress: string, reviewId?: string | null, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, manualTimeSpent?: string | null, numTimesUpdated: number, providersConsumedOn: Array<string>, showExtraInformation?: { season: number, episode: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { volume?: number | null, chapter?: string | null } | null } | null, collections: Array<{ id: string, details: { createdOn: string, information?: any | null, collectionId: string, lastUpdatedOn: string, creatorUserId: string, collectionName: string } }>, showProgress?: Array<{ timesSeen: number, seasonNumber: number, episodes: Array<{ episodeNumber: number, timesSeen: number }> }> | null, podcastProgress?: Array<{ episodeNumber: number, timesSeen: number }> | null } } };
...
export const CreateCustomMetadataGroupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCustomMetadataGroup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateCustomMetadataGroupInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCustomMetadataGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateCustomMetadataGroupMutation, CreateCustomMetadataGroupMutationVariables>;
export const UpdateCustomMetadataGroupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCustomMetadataGroup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCustomMetadataGroupInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCustomMetadataGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<UpdateCustomMetadataGroupMutation, UpdateCustomMetadataGroupMutationVariables>;
export const CreateCustomPersonDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCustomPerson"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateCustomPersonInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCustomPerson"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateCustomPersonMutation, CreateCustomPersonMutationVariables>;
export const UpdateCustomPersonDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCustomPerson"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCustomPersonInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCustomPerson"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<UpdateCustomPersonMutation, UpdateCustomPersonMutationVariables>;
...
export const CreateOrUpdateUserMeasurementDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateOrUpdateUserMeasurement"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserMeasurementInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createOrUpdateUserMeasurement"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<CreateOrUpdateUserMeasurementMutation, CreateOrUpdateUserMeasurementMutationVariables>;
...
export const DeleteUserImportReportDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteUserImportReport"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"importReportId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteUserImportReport"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"importReportId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"importReportId"}}}]}]}}]} as unknown as DocumentNode<DeleteUserImportReportMutation, DeleteUserImportReportMutationVariables>;
...
export const DeployUpdateMediaTranslationsJobDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeployUpdateMediaTranslationsJob"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MediaTranslationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deployUpdateMediaTranslationsJob"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<DeployUpdateMediaTranslationsJobMutation, DeployUpdateMediaTranslationsJobMutationVariables>;
...
export const MediaTranslationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MediaTranslation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MediaTranslationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mediaTranslation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MediaTranslationValue"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MediaTranslationPending"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]}}]} as unknown as DocumentNode<MediaTranslationQuery, MediaTranslationQueryVariables>;
