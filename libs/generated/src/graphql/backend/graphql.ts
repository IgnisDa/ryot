...
export type CoreDetailsQuery = { coreDetails: { version: string, timezone: string, authorName: string, repositoryLink: string, docsLink: string, itemDetailsHeight: number, reviewsDisabled: boolean, pageLimit: number, tokenValidForDays: number } };
