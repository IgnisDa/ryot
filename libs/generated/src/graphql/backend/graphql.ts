...
export type UserEnabledFeaturesQuery = { userEnabledFeatures: { general: { fileStorage: { enabled: boolean } }, metadata: { audioBooks: boolean, books: boolean, movies: boolean, podcasts: boolean, shows: boolean, videoGames: boolean } } };
