...
export type BooksSearchQuery = { booksSearch: { total: number, limit: number, books: Array<{ identifier: string, title: string, authorNames: Array<string>, image?: string | null, publishYear?: number | null }> } };
