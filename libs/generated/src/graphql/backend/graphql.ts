...
export type UserAccessLinksQuery = { userAccessLinks: Array<{ id: string, name: string, createdOn: string, expiresOn?: string | null, timesUsed: number, isRevoked?: boolean | null, maximumUses?: number | null, isMutationAllowed?: boolean | null }> };
