...
export type CreatorDetailsQuery = { creatorDetails: { details: { id: number, name: string, displayImages: Array<string> }, contents: Array<{ name: string, items: Array<{ metadataId?: number | null, title: string, image?: string | null }> }> } };
