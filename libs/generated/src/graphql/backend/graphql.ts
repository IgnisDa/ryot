...
export type MutationRoot = {
  ...
  deployUpdateAllMetadataJobs: Array<Scalars['String']>;
...
export type DeployUpdateAllMetadataJobsMutationVariables = Exact<{ [key: string]: never; }>;


export type DeployUpdateAllMetadataJobsMutation = { deployUpdateAllMetadataJobs: Array<string> };
...
export const DeployUpdateAllMetadataJobsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeployUpdateAllMetadataJobs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deployUpdateAllMetadataJobs"}}]}}]} as unknown as DocumentNode<DeployUpdateAllMetadataJobsMutation, DeployUpdateAllMetadataJobsMutationVariables>;
