...
export type CollectionToEntityDetailsPartFragment = { id: string, createdOn: string, lastUpdatedOn: string, information?: any | null, collection: { id: string, name: string, userId: string } };
