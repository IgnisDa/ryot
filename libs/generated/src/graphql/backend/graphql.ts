...
export type ChangeCollectionEntity = {
...
export type ChangeCollectionToEntityInput = {
  ...
  entityId: ChangeCollectionEntity;
  entityLot: EntityLot;
};
...
export type ExerciseDetailsQuery = { exerciseDetails: { lot: ExerciseLot, source: ExerciseSource, level: ExerciseLevel, force?: ExerciseForce | null, mechanic?: ExerciseMechanic | null, equipment?: ExerciseEquipment | null, muscles: Array<ExerciseMuscle>, attributes: { instructions: Array<string>, images: Array<string> } } };
...
export type UserWorkoutListQuery = { userWorkoutList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: string, name?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: string, reps: number, distance: string, duration: string }, exercises: Array<{ numSets: number, id: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: string | null, distance?: string | null, reps?: number | null, weight?: string | null, oneRm?: string | null } } }> } }> } };
