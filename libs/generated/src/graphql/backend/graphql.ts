...
export type QueryRootCreateFilterPresetArgs = {
  input: CreateFilterPresetInput;
};


export type QueryRootDeleteFilterPresetArgs = {
  filterPresetId: Scalars['UUID']['input'];
};
...
export type QueryRootUpdateFilterPresetLastUsedArgs = {
  filterPresetId: Scalars['UUID']['input'];
};
...
export type MediaTranslationsQuery = { mediaTranslations: { cacheId: string, response?: { title?: string | null, description?: string | null } | null } };
...
export type FilterPresetsQuery = { filterPresets: { cacheId: string, response: Array<{ id: string, name: string, filters: any }> } };
