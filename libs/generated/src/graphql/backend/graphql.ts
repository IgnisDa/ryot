...
export type PersonDetailsQuery = { personDetails: { details: { id: string, name: string, source: MediaSource, identifier: string, isPartial?: boolean | null, description?: string | null, birthDate?: string | null, deathDate?: string | null, place?: string | null, website?: string | null, gender?: string | null, displayImages: Array<string>, sourceUrl?: string | null }, contents: Array<{ name: string, count: number, items: Array<{ entityId: string, character?: string | null }> }> } };
