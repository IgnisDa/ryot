...
export type WorkoutDetailsQuery = { workoutDetails: { name: string, comment?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, exercises: Array<{ numSets: number, name: string, lot: ExerciseLot, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> }, information: { assets: { images: Array<string>, videos: Array<string> }, exercises: Array<{ exerciseName: string, exerciseId: number, notes: Array<string>, restTime?: number | null, total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, assets: { images: Array<string>, videos: Array<string> }, sets: Array<{ lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } }> }> } } };
