...
export type PublicCollectionsListQuery = { publicCollectionsList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: number, name: string }> } };
