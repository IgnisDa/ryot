...
export type UserWorkoutListQuery = { userWorkoutList: { details: { total: number, nextPage?: number | null }, items: Array<{ id: string, name?: string | null, startTime: Date, endTime: Date, summary: { total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, exercises: Array<{ numSets: number, name: string, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> } }> } };
...
export type WorkoutSummaryPartFragment = { total: { personalBestsAchieved: number, weight: number, reps: number, distance: number, duration: number }, exercises: Array<{ numSets: number, name: string, bestSet: { lot: SetLot, personalBests: Array<WorkoutSetPersonalBest>, statistic: { duration?: number | null, distance?: number | null, reps?: number | null, weight?: number | null } } }> };
