...
export type CollectionItem = {
  collectionDetails: CollectionItemDetail;
...
export type CreateOrUpdateCollectionInput = {
  description?: InputMaybe<Scalars['String']>;
  name: Scalars['String'];
  updateId?: InputMaybe<Scalars['Identifier']>;
...
export type GraphqlUserYankIntegration = {
...
export type MutationRootDeleteUserYankIntegrationArgs = {
  yankIntegrationId: Scalars['Int'];
};
...
export type QueryRoot = {
  ...
  userYankIntegrations: Array<GraphqlUserYankIntegration>;
};
...
export type CreateOrUpdateCollectionMutation = { createOrUpdateCollection: { id: any } };
...
export type DeleteUserYankIntegrationMutationVariables = Exact<{
  yankIntegrationId: Scalars['Int'];
}>;
...
export type CollectionsQuery = { collections: Array<{ collectionDetails: { id: number, name: string }, mediaDetails: Array<{ identifier: string, lot: MetadataLot, title: string, image?: string | null, publishYear?: number | null }> }> };
...
export type MediaSearchQuery = { mediaSearch: { total: number, nextPage?: number | null, items: Array<{ databaseId?: any | null, item: { identifier: string, title: string, image?: string | null, publishYear?: number | null } }> } };
...
export type PartialCollectionsQuery = { collections: Array<{ collectionDetails: { id: number, name: string, description?: string | null, visibility: Visibility, numItems: number } }> };
...
export type UserPreferencesQuery = { userPreferences: { featuresEnabled: { anime: boolean, audioBooks: boolean, books: boolean, manga: boolean, movies: boolean, podcasts: boolean, shows: boolean, videoGames: boolean } } };

export type UserSummaryQueryVariables = Exact<{ [key: string]: never; }>;


export type UserSummaryQuery = { userSummary: { calculatedOn: Date, media: { manga: { chapters: number, read: number }, books: { pages: number, read: number }, movies: { runtime: number, watched: number }, anime: { episodes: number, watched: number }, podcasts: { runtime: number, played: number, playedEpisodes: number }, videoGames: { played: number }, shows: { runtime: number, watchedEpisodes: number, watchedSeasons: number, watched: number }, audioBooks: { runtime: number, played: number } } } };

export type UserYankIntegrationsQueryVariables = Exact<{ [key: string]: never; }>;


export type UserYankIntegrationsQuery = { userYankIntegrations: Array<{ id: number, lot: UserYankIntegrationLot, description: string, timestamp: Date }> };
...
export const CollectionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Collections"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"collections"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"collectionDetails"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"mediaDetails"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"identifier"}},{"kind":"Field","name":{"kind":"Name","value":"lot"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"image"}},{"kind":"Field","name":{"kind":"Name","value":"publishYear"}}]}}]}}]}}]} as unknown as DocumentNode<CollectionsQuery, CollectionsQueryVariables>;
...
export const UserYankIntegrationsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UserYankIntegrations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userYankIntegrations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"lot"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}}]}}]}}]} as unknown as DocumentNode<UserYankIntegrationsQuery, UserYankIntegrationsQueryVariables>;