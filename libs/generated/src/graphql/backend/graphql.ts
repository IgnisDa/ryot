...
export type FeatureEnabled = {
  ...
  metadata: Array<MetadataFeatureEnabled>;
};
...
export type UserEnabledFeaturesQuery = { userEnabledFeatures: { general: { fileStorage: { enabled: boolean } }, metadata: Array<{ name: MetadataLot, enabled: boolean }> } };
