...
export type MutationRoot = {
  ...
  associateSeenItemWithReview: Scalars['Boolean']['output'];
...
export type MutationRootAssociateSeenItemWithReviewArgs = {
  reviewId: Scalars['String']['input'];
...
export type AssociateSeenItemWithReviewMutationVariables = Exact<{
  reviewId: Scalars['String']['input'];
  seenId: Scalars['String']['input'];
}>;


export type AssociateSeenItemWithReviewMutation = { associateSeenItemWithReview: boolean };
...
export const AssociateSeenItemWithReviewDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AssociateSeenItemWithReview"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"reviewId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"seenId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"associateSeenItemWithReview"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"reviewId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"reviewId"}}},{"kind":"Argument","name":{"kind":"Name","value":"seenId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"seenId"}}}]}]}}]} as unknown as DocumentNode<AssociateSeenItemWithReviewMutation, AssociateSeenItemWithReviewMutationVariables>;
