...
export type CollectionContentsQuery = { collectionContents: { collectionDetails: { name: string }, media: Array<{ identifier: string, lot: MetadataLot, title: string, image?: string | null, publishYear?: number | null }> } };
