...
export type GetOrFetchEntityTranslationsMutation = { getOrFetchEntityTranslations: { response: Array<{ value?: string | null, variant: EntityTranslationVariant, entityId: string, entityLot: EntityLot }> } };
