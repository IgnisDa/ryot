...
export type UserGeneralDashboardCommonPreferences = {
  index: Scalars['Int']['output'];
  isHidden: Scalars['Boolean']['output'];
  settings: UserGeneralDashboardElementCommonPreference;
};

export type UserGeneralDashboardElementCommonPreference = {
  numElements: Scalars['Int']['output'];
};

export type UserGeneralDashboardNoSettingsPreferences = {
  index: Scalars['Int']['output'];
  isHidden: Scalars['Boolean']['output'];
  settings: Scalars['Boolean']['output'];
};

export type UserGeneralDashboardPreferences = {
  activity: UserGeneralDashboardNoSettingsPreferences;
  inProgress: UserGeneralDashboardCommonPreferences;
  recommendations: UserGeneralDashboardCommonPreferences;
  summary: UserGeneralDashboardNoSettingsPreferences;
  upcoming: UserGeneralDashboardCommonPreferences;
};
...
export type UserGeneralDashboardCommonPreferencesPartFragment = { __typename: 'UserGeneralDashboardCommonPreferences', index: number, isHidden: boolean, settings: { numElements: number } };

export type UserGeneralDashboardNoSettingsPreferencesPartFragment = { __typename: 'UserGeneralDashboardNoSettingsPreferences', index: number, isHidden: boolean };
...
export const UserGeneralDashboardCommonPreferencesPartFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserGeneralDashboardCommonPreferencesPart"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UserGeneralDashboardCommonPreferences"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"index"}},{"kind":"Field","name":{"kind":"Name","value":"isHidden"}},{"kind":"Field","name":{"kind":"Name","value":"settings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"numElements"}}]}}]}}]} as unknown as DocumentNode<UserGeneralDashboardCommonPreferencesPartFragment, unknown>;
export const UserGeneralDashboardNoSettingsPreferencesPartFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserGeneralDashboardNoSettingsPreferencesPart"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UserGeneralDashboardNoSettingsPreferences"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"index"}},{"kind":"Field","name":{"kind":"Name","value":"isHidden"}}]}}]} as unknown as DocumentNode<UserGeneralDashboardNoSettingsPreferencesPartFragment, unknown>;
