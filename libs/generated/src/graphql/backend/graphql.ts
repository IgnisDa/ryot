...
export type GetOidcAuthorizationUrlQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOidcAuthorizationUrlQuery = { getOidcAuthorizationUrl: { url: string, csrf: string, nonce: string } };
...
export const GetOidcAuthorizationUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOidcAuthorizationUrl"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getOidcAuthorizationUrl"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"csrf"}},{"kind":"Field","name":{"kind":"Name","value":"nonce"}}]}}]}}]} as unknown as DocumentNode<GetOidcAuthorizationUrlQuery, GetOidcAuthorizationUrlQueryVariables>;
