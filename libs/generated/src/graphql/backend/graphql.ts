...
export type QueryRoot = {
  ...
  userRecommendations: Array<PartialMetadata>;
...
export type CoreDetailsQuery = { coreDetails: { isPro: boolean, version: string, docsLink: string, pageLimit: number, websiteUrl: string, authorName: string, oidcEnabled: boolean, repositoryLink: string, localAuthDisabled: boolean, tokenValidForDays: number } };
...
export type UserIntegrationsQuery = { userIntegrations: Array<{ id: string, lot: IntegrationLot, source: IntegrationSource, createdOn: string, lastTriggeredOn?: string | null, syncToOwnedCollection?: boolean | null }> };
...
export type UserRecommendationsQuery = { userRecommendations: Array<{ id: string, lot: MediaLot, source: MediaSource, identifier: string, title: string, image?: string | null }> };
...
export type SeenPartFragment = { id: string, state: SeenState, progress: string, startedOn?: string | null, finishedOn?: string | null, lastUpdatedOn: string, totalTimeSpent?: number | null, manualTimeSpent?: string | null, numTimesUpdated: number, providerWatchedOn?: string | null, showExtraInformation?: { episode: number, season: number } | null, podcastExtraInformation?: { episode: number } | null, animeExtraInformation?: { episode?: number | null } | null, mangaExtraInformation?: { chapter?: number | null, volume?: number | null } | null };
