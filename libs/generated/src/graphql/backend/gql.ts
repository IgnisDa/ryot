...
const documents = {
    ...
    "query UserCalendarEvents($startTime: NaiveDate, $endTime: NaiveDate) {\n  userCalendarEvents(startTime: $startTime, endTime: $endTime) {\n    calendarEventId\n    metadataId\n    metadataTitle\n    showSeasonNumber\n    showEpisodeNumber\n    podcastEpisodeNumber\n  }\n}": types.UserCalendarEventsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query UserCalendarEvents($startTime: NaiveDate, $endTime: NaiveDate) {\n  userCalendarEvents(startTime: $startTime, endTime: $endTime) {\n    calendarEventId\n    metadataId\n    metadataTitle\n    showSeasonNumber\n    showEpisodeNumber\n    podcastEpisodeNumber\n  }\n}"): (typeof documents)["query UserCalendarEvents($startTime: NaiveDate, $endTime: NaiveDate) {\n  userCalendarEvents(startTime: $startTime, endTime: $endTime) {\n    calendarEventId\n    metadataId\n    metadataTitle\n    showSeasonNumber\n    showEpisodeNumber\n    podcastEpisodeNumber\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query UserExerciseDetails($exerciseId: Int!) {\n  userExerciseDetails(exerciseId: $exerciseId) {\n    history {\n      workoutId\n      workoutName\n      workoutTime\n      sets {\n        lot\n        statistic {\n          duration\n          distance\n          reps\n          weight\n        }\n      }\n    }\n    details {\n      exerciseId\n      numTimesPerformed\n      lastUpdatedOn\n      extraInformation {\n        lifetimeStats {\n          weight\n          reps\n          distance\n          duration\n        }\n        personalBests {\n          lot\n          sets {\n            workoutId\n            setIdx\n            data {\n              statistic {\n                duration\n                distance\n                reps\n                weight\n              }\n              lot\n              personalBests\n            }\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query UserExerciseDetails($exerciseId: Int!) {\n  userExerciseDetails(exerciseId: $exerciseId) {\n    history {\n      workoutId\n      workoutName\n      workoutTime\n      sets {\n        lot\n        statistic {\n          duration\n          distance\n          reps\n          weight\n        }\n      }\n    }\n    details {\n      exerciseId\n      numTimesPerformed\n      lastUpdatedOn\n      extraInformation {\n        lifetimeStats {\n          weight\n          reps\n          distance\n          duration\n        }\n        personalBests {\n          lot\n          sets {\n            workoutId\n            setIdx\n            data {\n              statistic {\n                duration\n                distance\n                reps\n                weight\n              }\n              lot\n              personalBests\n            }\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
