...
const documents = {
    ...
    "mutation MediaTrackerImport($input: MediaTrackerImportInput!) {\n  mediaTrackerImport(input: $input) {\n    import {\n      total\n    }\n    failedItems {\n      lot\n      step\n      identifier\n    }\n  }\n}": types.MediaTrackerImportDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation MediaTrackerImport($input: MediaTrackerImportInput!) {\n  mediaTrackerImport(input: $input) {\n    import {\n      total\n    }\n    failedItems {\n      lot\n      step\n      identifier\n    }\n  }\n}"): (typeof documents)["mutation MediaTrackerImport($input: MediaTrackerImportInput!) {\n  mediaTrackerImport(input: $input) {\n    import {\n      total\n    }\n    failedItems {\n      lot\n      step\n      identifier\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
