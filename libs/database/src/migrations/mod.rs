...
mod m20240526_0_change_review_primary_key;
mod m20240526_1_change_seen_primary_key;
mod m20240526_2_change_collection_primary_key;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20240526_0_change_review_primary_key::Migration),
            Box::new(m20240526_1_change_seen_primary_key::Migration),
            Box::new(m20240526_2_change_collection_primary_key::Migration),
        ]
    }
}
