...
pub use m20230413_create_person::Person;
...
pub use m20230622_create_exercise::{
    Exercise, ExerciseEquipment, ExerciseForce, ExerciseLevel, ExerciseLot, ExerciseMechanic,
    ExerciseMuscle, ExerciseSource,
};
pub use m20230901_create_metadata_group::MetadataGroup;
