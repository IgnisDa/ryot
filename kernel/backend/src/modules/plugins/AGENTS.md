...
- Plugin reads use persisted plugin, revision, and installation state; nothing about the plugin catalog is held in process memory.
- User-scoped provider listings use `user_sandbox_provider`.
