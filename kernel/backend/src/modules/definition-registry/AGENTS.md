...
- Own immutable snapshots of schema, source-canonical saved-view, signal, and hook definitions. Definitions carry stable plugin identity plus a local slug; user state and persisted domain data do not belong here.
