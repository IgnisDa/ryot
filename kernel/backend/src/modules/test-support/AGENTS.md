...
`installSystemPlugin`, `listSystemPlugins`, `uninstallSystemPlugin`, and `reconcilePluginInstallations` retain system-only semantics used by active end-to-end callers.
