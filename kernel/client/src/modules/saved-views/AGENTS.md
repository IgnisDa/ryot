...
- The filters control and every add affordance are deliberately inert: they render the shape the screen keeps and log a TODO until the provider add flow exists. Do not delete them as dead code, and do not give them a stand-in implementation.
