...
- Saved-view routes publish the selected renderer to the shell client-page document host; do not add a parallel kernel-DOM rendering path. Header chrome, including the view name and icon, belongs to the renderer inside the iframe.
