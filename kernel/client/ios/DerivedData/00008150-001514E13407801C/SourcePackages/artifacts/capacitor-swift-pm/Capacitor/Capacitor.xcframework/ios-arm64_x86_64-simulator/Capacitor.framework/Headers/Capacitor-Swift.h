...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull capacitorSceneWillConnect;)
+ (NSNotificationName _Nonnull)capacitorSceneWillConnect SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull capacitorSceneOpenURL;)
+ (NSNotificationName _Nonnull)capacitorSceneOpenURL SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull capacitorSceneOpenUniversalLink;)
+ (NSNotificationName _Nonnull)capacitorSceneOpenUniversalLink SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS_NAMED("SceneDelegateProxy")
@interface CAPSceneDelegateProxy : NSObject <UISceneDelegate>
